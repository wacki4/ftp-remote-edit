...
import FtpSelectView from './ftp-select-view.js';
...
class TreeView extends ScrollView {
  ...
  static content() {
    return this.div({
      ...
      this.subview('ftpSelectView', new FtpSelectView());
      this.div({
  ...
  initialize(state) {
    ...
    atom.config.onDidChange('ftp-remote-edit.tree.showSelectOnTop', () => {
      if (self.isVisible()) {
        self.reload();
      }
    });
